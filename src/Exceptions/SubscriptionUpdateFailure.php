...
class SubscriptionUpdateFailure extends Exception
{
    ...
    {
        return new static(
            "The subscription \"{$subscription->square_id}\" cannot be updated because its payment is incomplete."
        );
    }
    ...
    {
        return new static(
            "The price \"$price\" is already attached to subscription \"{$subscription->square_id}\"."
        );
    }
    ...
    {
        return new static(
            "The price on subscription \"{$subscription->square_id}\" cannot be removed because it is the last one."
        );
    }
}
