...
class ChargesTest extends FeatureTestCase
{
    public function test_customer_can_be_charged()
    {
        ...
        $this->assertEquals($user->square_id, $response->customer);
    }

    public function test_non_square_customer_can_be_charged()
    {
        $user = $this->createCustomer('non_square_customer_can_be_charged');
    ...
    public function test_customer_can_be_charged_and_invoiced_immediately()
    {
        ...
        $this->assertEquals('Laravel Cashier', $invoice->invoiceItems()[0]->asSquareInvoiceLineItem()->description);
    }
